      ...
      setCourses([
        {
          ...
          description: 'Learn the basics of Dubai real estate market',
          status: 'published',
        ...
        },
        {
          ...
          description: 'Advanced investment strategies for real estate',
          status: 'draft',
              ...
              {loading ? (
                ...
                courses.map((course) => (
                  <TableRow key={course.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                    ...
                    <TableCell className="px-5 py-4">
                      <Badge size="sm" color={getStatusBadgeColor(course.status)}>

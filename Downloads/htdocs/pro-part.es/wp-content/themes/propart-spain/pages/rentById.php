...
<script src="<?php echo get_template_directory_uri(); ?>/js/pdf-generator.js"></script>
        ...
        <div class="project-desc">
          ...
          <div class="project-desc-right">
            <div class="project-desc-top">
                <!-- <p class="project-desc-reference" id="projectReference"></p> -->
            ...
            <div class="project-inner">
              <div class="project-l">
                ...
                <div class="project-desc-details m2price">
                  <div class="project-desc-block">
                    <strong class="project-desc-text">Price for m²</strong>
                ...
                <div class="project-desc-details">
                  <div class="project-desc-block">
                    <p class="project-desc-text">Condition</p>
                                <p class="project-desc-title">Rent</p>
                  </div>
                </div>
                <div class="project-desc-details">
                  <div class="project-desc-block">
                ...
                <div class="project-desc-details">
                  <div class="project-desc-block">
                    <p class="project-desc-text">Baths</p>
                    <p class="project-desc-title" id="projectBathrooms"></p>
                  </div>
                </div>
                <div class="project-desc-details">
                  <div class="project-desc-block">
                    <p class="project-desc-text">Total built</p>
                    <p class="project-desc-title" id="projectSize"></p>
                  </div>
                </div>
                <div class="project-desc-details">
                  <div class="project-desc-block">
                    <p class="project-desc-text">Living area</p>
                    <p class="project-desc-title" id="projectLivingArea"></p>
                  </div>
                </div>
                <div class="project-desc-details">
                  <div class="project-desc-block">
                    <p class="project-desc-text">Terrace</p>
                    <p class="project-desc-title" id="projectTerrace"></p>
                  </div>
                </div>
                <div class="project-action-buttons">
                  <button class="button-black" id="download-pdf-btn" title="Download project information in PDF format">
                    Download PDF
                  </button>
                  <button class="button-white" id="pricelist-btn" title="Request pricelist">
                    Pricelist
                  </button>
                </div>
            </div>
...
<!--               <div class="map-conatainer">
              <section class="mapProjectWrapper">
                  <div id="mapOffPlanById"></div>
...
<script>
    ...
    {
        "oldValue": "San Pedro de Alcantara",
    ...
    },
    {
        ...
        "locations": {
            ...
            "lng": "-5.2931"
                    ...
                    {
                        "oldValue": "San Pedro de Alcantara",
                        "newValue": "San Pedro de Alcantara",
                        "locations": {
                            "lat": "36.486468",
                            "lng": "-4.993133"
                        }
        ...
        <div class="project-inquiry-container">
            <div class="project-inquiry-left">
                ...
                <div class="project-inquiry-buttons">
                    <a href="https://wa.me/34695113333" target="_blank" class="button-black whatsapp-btn">
...
function renderSecondary(mainContent) {
  hideButtonsOnResizeSecondary();

  // Add event listeners for opening/closing gallery
  document
    .getElementById("viewPhotosBtn")
    .addEventListener("click", openGallerySecondary);
  document
    .getElementById("closeGallery")
    .addEventListener("click", closeGallerySecondary);
  document
...
function hideButtonsOnResizeSecondary() {
...
let currentImageSecondaryIndex = 0;
let imagesSecondary = [];
...
function createDots() {
  ...
  if (currentImageSecondaryIndex < maxDots) {
    start = 0;
    end = Math.min(numImages, maxDots);
  } else {
    start = currentImageSecondaryIndex - 4;
  ...
  for (let i = start; i < end; i++) {
    ...
    dot.addEventListener("click", () => showImageSecondary(i, "galleryImage"));
...
function updateDots() {
  ...
  dots.forEach((dot, index) => {
    ...
    dot.classList.toggle("active", 
      (currentImageSecondaryIndex < 5 && dotIndex === currentImageSecondaryIndex) ||
      (currentImageSecondaryIndex >= 5 && index === 4)
    );
  });
}


function openGallerySecondary() {
  console.log("Opening gallery, currentImageSecondaryIndex:", currentImageSecondaryIndex);
  ...
  document.body.style.overflow = "hidden";
  showImageSecondary(currentImageSecondaryIndex);
  createThumbnailsSecondary();
  createDots();
}

function closeGallerySecondary() {
  document.getElementById("galleryOverlay").style.display = "none";
  document.body.style.overflow = "";
}

function handleKeyPressSecondary(event) {
  if (event.key === "Escape") {
    closeGallerySecondary();
  }
}

function showImageSecondary(index, elementId = "galleryImage") {
  ...
  if (galleryImage && window.imagesSecondary && window.imagesSecondary[index]) {
    ...
    currentImageSecondaryIndex = index;
    updateThumbnailsSecondary();
  }
}

function changeImageSecondary(step) {
  if (!window.imagesSecondary || window.imagesSecondary.length === 0) {
    console.warn("No images available for changing");
    return;
  }
  
  currentImageSecondaryIndex =
    (currentImageSecondaryIndex + step + window.imagesSecondary.length) %
    window.imagesSecondary.length;
  showImageSecondary(currentImageSecondaryIndex, "galleryImage");
  showImageSecondary(currentImageSecondaryIndex, "sliderImage");
  updateDots(); 
}

function createThumbnailsSecondary() {
  ...
  window.imagesSecondary.forEach((src, index) => {
    ...
    thumb.onclick = () => {
      showImageSecondary(index, "galleryImage");
    };
...
function updateThumbnailsSecondary() {
  const thumbs = document.querySelectorAll(".thumbnail");
  thumbs.forEach((thumb, index) => {
    const isActive = index === currentImageSecondaryIndex;
...
window.addEventListener("resize", hideButtonsOnResizeSecondary);
        ...
        // Asynchronous function to fetch and render Swiper slides
        async function fetchAndRenderSlides() {
            ...
            try {
                // Xano API endpoint for rent properties
                const xanoParams = new URLSearchParams({
                    property_status: 'rent',
                    rent_type: currentRentType,
                    town: locationText,
                    perPage: '12',
                    curPage: '1'
                });
                ...
                const response = await fetch(
                    `https://xf9m-jkaj-lcsq.p7.xano.io/api:v5maUE6u/properties?${xanoParams.toString()}`, {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
                ...
                console.log('rent projects:', data);
                ...
                data.items?.forEach(project => {
                    ...
                    slide.innerHTML = `
        <a class="swiper-card"  href="${'/rent?project=' + project.id + '&rent_type=' + (project.rent_type || 'long')}">
          <div class="rectangle-parent">
            <div class="image-slider-container">
        		<div class="image-wrapper">
          		<img
            		class="frame-child current-image"
            		src="${project.images[0].large}"
    ...
    ${project.generalInfo.type
                    ? `
        <div class="off-plan-wrapper">
          <div class="off-plan">${project.generalInfo.type}</div>
        </div>`
                    : ""
                }
    ${project.generalInfo.floor
                    ? `
        <div class="off-plan-wrapper">
          <div class="off-plan">${project.generalInfo.floor.slice(", ")} beds</div>
        </div>`
                    : ""
                }
    ${project.generalInfo.size
                    ? `
        <div class="off-plan-wrapper" >
          <div class="off-plan">${project.generalInfo.size} m²</div>
        </div>`
                    : ""
                }
            </div>
    ...
    <div class="frame-container">
        ...
        <div class="marbella-spain">${project.generalInfo.province}, Spain</div>
              </div>
              <div class="parent">
...
function updateSwimmingPoolStatus(amenities, id, key) {
  const amenity = amenities.find((item) => item.key === key);
  const element = document.getElementById(id);
  if (element) {
    if (amenity && amenity.values.length > 0) {
      // Якщо ключ знайдено, виводимо його значення
      element.textContent = amenity.values.join(", ");
    } else {
      // Якщо ключ не знайдено, виводимо "Not Available"
      element.textContent = "Not Available";
    }
  }
}
  ...
  if (projectId) {
    fetch(`https://xf9m-jkaj-lcsq.p7.xano.io/api:v5maUE6u/properties/${projectId}`)
      ...
      .then((data) => {
        ...
        // --- 2. Get DOM Elements ---
        const projectReference = document.getElementById("projectReference");
        ...
        const projectBathrooms = document.getElementById("projectBathrooms");
        const projectLivingArea = document.getElementById("projectLivingArea");
        const projectTerrace = document.getElementById("projectTerrace");
        
        // --- 3. Populate General Info ---
        if (projectReference) projectReference.textContent = data.property_old_id || 'N/A';
        ...
        if (projectType) projectType.textContent = data.type;
        if (projectRooms) projectRooms.textContent = data.beds;
        if (projectBathrooms) projectBathrooms.textContent = data.baths;
        if (projectTotalFloors) projectTotalFloors.textContent = data.levels;
        if (projectSize) projectSize.textContent = `${data.built_area.toLocaleString("en-US").replace(/,/g, " ")} m²`;
        if (projectLivingArea) projectLivingArea.textContent = `${data.built_area.toLocaleString("en-US").replace(/,/g, " ")} m²`; // Using built_area as living_area
        if (projectTerrace && data.terrace_area) projectTerrace.textContent = `${data.terrace_area.toLocaleString("en-US").replace(/,/g, " ")} m²`;
        if (projectDescr) projectDescr.textContent = data.description;



        // --- 5. Populate Detailed Amenities List ---
        const amenitiesContainer = document.querySelector(".about-card-amenities");
        if (amenitiesContainer && data._category_values_of_properties) {
            // Clear previous amenities
            amenitiesContainer.innerHTML = ''; 

            // Group amenities by category
            const amenitiesByCategory = data._category_values_of_properties.reduce((acc, amenity) => {
                const categoryName = amenity._categories_4.name;
                if (!acc[categoryName]) {
                    acc[categoryName] = [];
                }
                acc[categoryName].push(amenity.value);
                return acc;
            }, {});

            // Create and append HTML for each category
            for (const category in amenitiesByCategory) {
                const detailsContainer = document.createElement("div");
                detailsContainer.className = "amenity-desc-details";

                const block = document.createElement("div");
                block.className = "amenity-desc-block";
                ...
                values.className = "about-card-amenity";
                values.textContent = amenitiesByCategory[category].join(", ");
                block.appendChild(values);

                detailsContainer.appendChild(block);
                amenitiesContainer.appendChild(detailsContainer);
            }
        }
        ...
        if (data.images && data.images.length > 0) {
          ...
          console.log("imagesSecondary populated:", window.imagesSecondary);
    
          const galleryImage = document.getElementById("galleryImage");
          const projectMainImg = document.getElementById("projectMainImg");
          const sliderImage = document.getElementById("sliderImage");

          if (galleryImage) galleryImage.src = window.imagesSecondary[0];
          if (projectMainImg) projectMainImg.src = window.imagesSecondary[0];
          if (sliderImage) sliderImage.src = window.imagesSecondary[0];
        
          // Initialize gallery functions after images are loaded
          createDots();
          updateDots();
          createThumbnailsSecondary();
          ...
          if (prevButton)
            prevButton.addEventListener("click", () => changeImageSecondary(-1));
          if (prevSlideButton)
            prevSlideButton.addEventListener("click", () => changeImageSecondary(-1));

          if (nextButton)
            nextButton.addEventListener("click", () => changeImageSecondary(1));
          if (nextSlideButton)
            nextSlideButton.addEventListener("click", () => changeImageSecondary(1));
            
          // Add swipe handlers for mobile
          if (window.innerWidth <= 768) {
            addSwipeHandlersSecondary();
          }
          
          // Add keyboard event listener
          document.addEventListener("keydown", handleKeyPressSecondary);
		  ...
		  const favoriteBtn = document.getElementById('add-to-favorites');
      if(favoriteBtn) {
          const storageKey = 'favoriteSecondaryProjects';
    ...
    console.log("No 'id' query string found in the URL");
  }
}
  ...
  if (pricelistBtn) {
    pricelistBtn.addEventListener('click', function() {
      ...
      if (feedbackBlock) {
        ...
        feedbackBlock.style.transition = 'transform 0.3s ease';
        feedbackBlock.style.transform = 'scale(1.02)';
        setTimeout(() => {
          feedbackBlock.style.transform = 'scale(1)';
        }, 300);
      }
    });
  }

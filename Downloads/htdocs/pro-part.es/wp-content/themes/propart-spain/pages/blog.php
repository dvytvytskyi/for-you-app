...
?>
   <main id="main-content">
    ...
    <section class="blogInside">
      <div class="blog-links">
        <div class="blog-links-inner">
          <a class="blog-links__back" href="javascript:void(0);" onclick="window.history.back();">Back</a>
        </div>
        <div class="blog-links__link">
          <a class="blog-links__items" target="_blank">
            <img
              class="blog-links__img"
              src="<?php echo get_template_directory_uri(); ?>/icons/blog/share.svg"
              alt="Share Icon"
            />
          </a>
          <a class="blog-links__items" href="https://x.com/" target="_blank">
            <img
              class="blog-links__img"
              src="<?php echo get_template_directory_uri(); ?>/icons/blog/twitter.svg"
              alt="Twitter Icon"
          /></a>
          <a
            class="blog-links__items"
            href="https://www.facebook.com/"
            target="_blank"
          >
            <img
              class="blog-links__img"
              src="<?php echo get_template_directory_uri(); ?>/icons/blog/facebook.svg"
              alt="Facebook Icon"
            />
          </a>
        </div>
      ...
      $blog_post = get_blog_post_by_id($blog_id); // Fetch the blog post


      if ($blog_post): // Check if the blog post exists
        ?>
           <div class="blog-inner">
        <div class="blog-inner__main">
          <div class="blog-inner__main-date">
            <p class="blog-inner__date-text"><?php echo esc_html($blog_post['date']); ?></p>
            <span class="blog-inner__date-line"></span>
          </div>
          <div class="blog-inner__main-title">
            <h1 class="blog-inner__main-titleText">
            <?php echo esc_html($blog_post['nazvanie_bloga']); ?>
            </h1>
          </div>
          <?php echo $blog_post['opisanie']; ?>
        </div>
        <?php
        else:
        ...
        <aside class="blog-inner__aside">
          <div class="blog-inner__main-date">
            <div class="blog-button__block">
              <p class="blog-inner__date-text">Other articles</p>
              <div class="blog-inner__buttons">
                <button class="slidePrev" disabled>
                  <img
                    src="<?php echo get_template_directory_uri(); ?>/icons/blog/arrow-left.svg"
                    alt="Arrow Left"
                    class="blog-inner__buttons--arrows"
                  />
                </button>
                <button class="slideNext">
                  <img
                    src="<?php echo get_template_directory_uri(); ?>/icons/blog/arrow-left.svg"
                    alt="Arrow Left"
                    class="blog-inner__buttons--arrows arrow-right"
                  />
                </button>
              </div>
            </div>

            <span class="blog-inner__date-line blog-inner__aside-line"></span>
          </div>
          <div class="blog-articles">
            <div class="blog-articles__items">
              <img
                src="<?php echo get_template_directory_uri(); ?>/images/blog/articles.jpg"
                alt="Articles"
              />
              <div class="blog-articles__text">
                <h3 class="blog-articles__title">
                  A Guide to Buying Property in Spain as a Foreigner
                </h3>
                <a href="#blogsorting" class="blog-articles__link">Read more</a>
              </div>
            </div>
            <div class="blog-articles__items">
              <img
...
function renderBlogPage(mainContent) {
  ...
  const slides = document.querySelectorAll(".blog-articles__items");
  const copyLink = mainContent.querySelectorAll(".blog-links__items")[0]
  const xLink = mainContent.querySelectorAll(".blog-links__items")[1]
  const facebookLink = mainContent.querySelectorAll(".blog-links__items")[2]
...
xLink.href = `https://twitter.com/intent/tweet?url=${currentUrl}`;
facebookLink.href = `https://www.facebook.com/sharer/sharer.php?u=${currentUrl}`;
  ...
  const updateSliderPosition = () => {
    ...
    blogArticles.scrollLeft = currentSlide * slideWidth;
    checkButtons();
  };

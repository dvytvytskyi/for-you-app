...
?>
    <main id="main-container">
		<nav id="bottom-navbar" class="bottom-nav"></nav>
      <div class="consultingPage">
        <section class="headingBlock">
          <h1 class="pageHeading">Consulting</h1>
          <p class="pageDescription">
            Our experienced consultants offer personalized guidance in the Costa
            del Sol real estate market, helping you find the right property and
            navigate legal and tax matters for a smooth and successful
            investment.
          </p>
        </section>
        <section class="servicesBlock">
          <a class="serviceCard" href="/legal-service">
            <span class="serviceNumber">01</span>
            <p class="serviceHeader">Legal services</p>
            <div class="serviceInfo">
              <p class="infoItem">Company registration</p>
              <p class="infoItem">Company registration</p>
              <p class="infoItem">Opening bank account</p>
            </div>
            <div class="moreLink">Read more</div>
          </a>
          <a class="serviceCard" href="/concierge-service">
            <span class="serviceNumber">03</span>
            <p class="serviceHeader">Concierge</p>
            <div class="serviceInfo">
              <p class="infoItem">Property upkeep</p>
              <p class="infoItem">Personalized service</p>
              <p class="infoItem">Transportation services</p>
              <p class="infoItem">Caring for children</p>
            </div>
            <div class="moreLink">Read more</div>
          </a>
          <a class="serviceCard" href="/visa-service">
            <span class="serviceNumber">02</span>
            <p class="serviceHeader">Visa</p>
            <div class="serviceInfo">
              <p class="infoItem">Visa for investor</p>
              <p class="infoItem">Golden visa</p>
              <p class="infoItem">Student visa</p>
            </div>
            <div class="moreLink">Read more</div>
          </a>
          <a class="serviceCard" href="/insurance-service">
            <span class="serviceNumber">04</span>
            <p class="serviceHeader">Insurance</p>
            <div class="serviceInfo">
              <p class="infoItem">Medical insurance</p>
              <p class="infoItem">Property insurance</p>
            </div>
            <div class="moreLink">Read more</div>
          </a>
          <a class="serviceCard" href="/construction-service">
            <span class="serviceNumber">05</span>
            <p class="serviceHeader">Construction</p>
            <div class="serviceInfo">
              <p class="infoItem">Residential сonstruction</p>
              <p class="infoItem">Turnkey solutions</p>
              <p class="infoItem">Luxury property development</p>
              <p class="infoItem">Interior design</p>
            </div>
            <div class="moreLink">Read more</div>
          </a>
          <a class="serviceCard" href="/mortgage">
            <span class="serviceNumber">06</span>
            <p class="serviceHeader">Mortgage</p>
            <div class="serviceInfo">
              <p class="infoItem">Mortgage сonsultation</p>
              <p class="infoItem">Pre-approval assistance</p>
              <p class="infoItem">Mortgage application support</p>
            </div>
            <div href="#mortgage-service" class="moreLink">Read more</div>
          </a>
        </section>
        <section class="statsBlock">
          ...
          <div class="statsItem">
            ...
            <p class="statsDescription">different</br> projects</p>
          </div>
          <div class="statsItem">
            <p class="statsNumber">50+</p>
        ...
        <section class="advantagesBlock">
          <p class="advantagesHeader">Why choose us</p>
          <div class="advantageCardsContainer">
            <div class="advantageCard">
              <span class="advantageIcon dandruff-icon"></span>
              <div>
                <p class="advantageTitle">Local expertise</p>
                <p class="advantageDescription">
                  Our consultants expertly navigate the Costa del Sol market,
                  from Marbella to Estepona, to find the perfect
                  property—whether a luxury villa or a cozy apartment—tailored
                  to your personal and investment goals.
                </p>
              </div>
            </div>
            <div class="advantageCard">
              <span class="advantageIcon scale-icon"></span>
              <div>
                <p class="advantageTitle">Legal and regulatory guidance</p>
                <p class="advantageDescription">
                  We offer complete legal support in real estate, ensuring your
                  transactions comply with all laws, from golden visas to zoning
                  regulations.
                </p>
              </div>
            </div>
            <div class="advantageCard">
              <span class="advantageIcon lamp-icon"></span>
              <div>
                <p class="advantageTitle">Financial insights</p>
                <p class="advantageDescription">
                  Our experts provide clear guidance on taxes, mortgages, and
                  investment returns to help you make informed real estate
                  decisions.
                </p>
              </div>
            </div>
            <div class="advantageCard">
              <span class="advantageIcon diamond-icon"></span>
              <div>
                <p class="advantageTitle">Access to exclusive listings</p>
                <p class="advantageDescription">
                  With our extensive network, we offer access to exclusive
                  properties and early insights into top offers and investment
                  opportunities, giving our clients a distinct competitive edge.
                </p>
              </div>
            </div>
            <div class="advantageCard">
              <span class="advantageIcon face-icon"></span>
              <div>
                <p class="advantageTitle">Personalized strategy</p>
                <p class="advantageDescription">
                  We offer customized strategies and solutions tailored to your
                  goals, including market analysis, investment forecasts and
                  property selection.
                </p>
              </div>
            </div>
            <div class="advantageCard">
              <span class="advantageIcon screen-icon"></span>
              <div>
                <p class="advantageTitle">Post-purchase support</p>
                <p class="advantageDescription">
                  We provide comprehensive post-purchase support: property
                  management, renovation and resale advice to ensure your
                  investment remains profitable over time.
                </p>
              </div>
            </div>
          </div>

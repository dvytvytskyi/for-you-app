...
get_header();
?>
    <main class="areaPage" id="main-content">
		<nav id="bottom-navbar" class="bottom-nav">
	</nav>
        <section class="headersotogrande">
            <div class="AreaContent">
                <a class="arrow-left-parent-area" href="/#areas"> 
                <div class="arrow-left-parent-area">   
                    <img   class="arrow-left-icon-area" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/arrow-area.svg" alt="all" />
                    <a href="/areas" class="all-areas">All areas</a> 
                </div> 
              </a>
              <div class="estepona">Sotogrande</div> 

             <div class="real-time-weather-parent">
                <div class="real-time-weather">Real-time weather</div> 
                <div class="weather-tab">
                    <div class="weather-sun-date">
                        <div class="weather-sun-temp">
                            <img class="huge-iconweatheroutlinesun" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/sun.svg">
                            <div class="temp-23">23
                                <sup>o</sup>
                            </div> 
                        </div>
                        <div class="todaymain">Today</div> 
                    </div> 
                    <div class="bort-line"> </div> 
                    <div class="weather-sun-date">  
                        <div class="weather-sun-temp">
                            <img class="huge-iconweatheroutlinesun" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/cloud-sun.svg">
                            <div class="temp-26">26
                                <sup class="grad">o</sup>
                            </div> 
                        </div>
                    ...
                    <div class="weather-sun-date">  
                        <div class="weather-sun-temp">
                            <img class="huge-iconweatheroutlinesun" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/cloud-sun.svg">
                            <div class="temp-26">24
                                <sup class="grad">o</sup>
                            </div> 
                        </div>
                        <div class="today">Saturday</div> 
                    </div> 
                </div> 
             </div>

              <div class="real-time-detail">
              <div class="how-long-it">How long it takes from</div>
  
              <div class="weather-detail">
                 <div class="city-column">
                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/airplane.svg">
                            <div class="h-time">4.3h</div>
                        </div>
                        <div class="city-country">London, UK</div>
                    </div>

                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/airplane.svg">
                            <div class="h-time">9.3h</div>
                        </div>
                        <div class="city-country">Dubai, UAE</div>
                    </div>
                    ...
                    <div class="city-and-time">
                        ...
                        <div class="city-country">New York, USA</div>
                    </div>

                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/airplane.svg">
                            <div class="h-time">2h</div>
                        </div>
                        <div class="city-country">Madrid, ESP</div>
                    </div>
                 </div>
                 ...
                 <div class="city-column">
                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/driving.svg">
                            <div class="h-time">1h</div>
                        </div>
                        <div class="city-country">Malaga, ESP</div>
                    </div>
                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/driving.svg">
                            <div class="h-time">2.4h</div>
                        </div>
                        <div class="city-country">Sevilia, ESP</div>
                    </div>
                 </div>
            </div>  
            ...
            <div class="position-dor-scroll">  
            <div class="rectangle-parent-line">
                <div class="scroll-mob"> </div>
                <div class="scroll-size-mob"> 
            </div>
        </div>
        </section>


        <section class="inform-tab-mob"> 
            <div class="real-time-weather-parent-mob">  
            <div class="real-time-weather-mob">Real-time weather</div> 
            <div class="weather-tab">
                <div class="weather-sun-date">
                    <div class="weather-sun-temp">
                        <img class="huge-iconweatheroutlinesun" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/sun_black.svg">
                        <div class="temp-23">23
                            <sup>o</sup>
                        </div> 
                    </div>
                ...
                <div class="weather-sun-date">  
                    <div class="weather-sun-temp">
                        <img class="huge-iconweatheroutlinesun" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/cloud-sun-mob.svg">
                        <div class="temp-26">26
                            <sup class="grad">o</sup>
                        </div> 
                    </div>
           ...
           <div class="real-time-detail-mob">
            <div class="how-long-it">How long it takes from</div>
            ...
            <div class="weather-detail">
                <div class="city-column">
                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/airplane-mob.svg">
                            <div class="h-time">4.3h</div>
                        </div>
                        <div class="city-country">London, UK</div>
                    </div> 
                 ...
                 <div class="city-column">
                    <div class="city-and-time">
                        <div class="plane-time">
                            <img class="airplane-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/icons/icons-areapages/driving-mob.svg">
                            <div class="h-time">1h</div>
                        </div>
                        <div class="city-country">Malaga, ESP</div>
                    </div> 
        ...
        <section class="about-area-parent"> 
                <div class="about-area">About area </div>
                <div class="estepona-a-charming">
                    It all started in 1962 when Filipino Freddy Melian received a free ticket to Spain from Swissair for being a frequent
                     flier on the airline. Melian was employed by the Ayala Corporation in Makati (now part of Metro Manila, Philippines),
                      and this company was the owner of many very upscale and exclusive housing developments like Forbes Park.
                </div>
        </section>

        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/area/photo3.webp">
        </section>

        <section class="history-parent">
            <div class="backText">History</div>
            <div class="history">History</div>
            <div class="text-blocks-history">
                <div class="text-history-part">
                    The first thing that McMicking did was in 1964 to hire Robert Trent Jones to design the first golf course in Sotogrande.
                     At that time Robert Trent Jones was the world’s foremost golf course designer in the world. The finished golf course 
                     was named Real Club de Golf Sotogrande. In 1965 the polo club was built and named La Playa. Soon after that there
                      were many major polo tournaments played in the club. Today there are eleven polo grounds and the most important 
                      tournaments are the Gold Cup and the Silver Cup. 
                </div> 
                <div class="text-history-part2">
                    About 45,000 persons attend the tournaments every year. The first hotel in Sotogrande was built in 1965 and called Tenis Hotel Sotogrande.
                     The architect chosen for this project was the prominent Madrid architect Jose Antonio Corrales Gutierrez.
                      The Marina was inaugurated in 1987 with the name Puerto Deportivo Sotogrande. 
                      The property on the left side of the estuary of the Rio Guadiaro was acquired and many luxury Marina apartments
                      have been built there. It contains the Real Club Maritimo de Sotogrande today.
                </div>
                <div class="text-history-part3">
                    <br>  
                    A notable golf course is the Valderrama, which held the Ryder Cup of 1997. This golf course is now considered as 
                    the best golf course in Europe. This golf course has also held the Volvo Masters from 1986-1996 and 2002, 
                    and the World Golf Championship sponsored by American Express in 1999 and 2000
                    </br>  

                     <br>
                     This golf course was called at first the Nuevo Sotogrande, built in 1974 by Robert Trent Jones and considered his masterpiece. 
                     In 1981 it was renamed Las Aves. In 1984 Jaime Ortiz-Patiño bought this course to hold the most challenging competitions 
                     and Jones redesigned the course and it was renamed Valderrama, which was the name of the original ranch located on this land. 
                     Today Sotogrande has four golf courses, namely Valderrama (ranked No. 1 in Europe), Real Club de Golf Sotogrande 
                     (ranked No. 7 in Europe), Almenara Golf, and La Reserva de Sotogrande.
                       </br> 
                </div>
        ...
        <!-- <section class="top-entertainment-parent">
                 <div class="backText">Entertainment</div>
            <div class="top-entertainment">Top entertainment</div>
            <div class="top-entertainment-text">
                Costa Del Sol  offers a wide variety of entertainment options, making it a top destination for visitors
                 seeking both relaxation and adventure. From thrilling fishing excursions to vibrant festivals held
                  in the charming historic old town, there is something for everyone. Explore Costa Del 
                  Sol’s rich cultural side through its art galleries, museums, and theaters, or embrace the outdoors by 
                  hiking and biking through the stunning Sierra Bermeja mountains.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/entertainment/art1.webp">
                <div class="name-art-gallery">Salduna Beach</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/entertainment/art2.webp">
                <div class="name-art-gallery">Trocadero Estepona</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/entertainment/art3.webp">
                <div class="name-art-gallery">Spiler Beach Club</div>
            </div>
            <div class="photo-gallery-group"  id="last-enter-ph">
                <img class="photo-gallery-item"  alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/entertainment/art4.webp">
                <div class="name-art-gallery">Beso Beach Estepona</div>
            </div>
        </section> -->


        <section class="top-entertainment-parent">
            <div class="backText">Restaurants</div>
            <div class="top-entertainment">Best restaurants</div>
            <div class="top-entertainment-text">
                Costa Del Sol  boasts a diverse selection of top restaurants, offering everything from traditional Andalusian cuisine to international dishes.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/restaurants/rest1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">MARXA Chiringuito</div>
                    <div class="descr-name-gallery">Anadalucian</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/restaurants/rest2.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Cortijo Santa María 1962</div>
                    <div class="descr-name-gallery">Andalusian</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/restaurants/rest3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">RocíoGarden</div>
                    <div class="descr-name-gallery">European</div>
                </div>
            </div>
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/restaurants/rest4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Ixo Tapas& Bar</div>
                    <div class="descr-name-gallery">Artisan cocktail bar</div>
                </div>
            </div>
        </section>

        <section class="top-entertainment-parent">
            <div class="backText">Golf clubs</div>
            <div class="top-entertainment">Top golf clubs</div>
            <div class="top-entertainment-text">
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/golf/golf1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">El Paraiso Golf Club</div>
                    <div class="descr-name-gallery">7:00 AM - 7:30 PM</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/golf/golf2.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Atalaya Golf Club</div>
                    <div class="descr-name-gallery">8:00 AM - 8:00 PM</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/golf/golf3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Valle Romano Golf Club</div>
                    <div class="descr-name-gallery">8:00 AM - 8:30 PM</div>
                </div>
            </div>
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/golf/golf4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">El Paraiso Golf Club</div>
                    <div class="descr-name-gallery">7:00 AM - 7:30 PM</div>
                </div>
        ...
        <section class="top-entertainment-parent">
            <div class="backText">Sport</div>
            <div class="top-entertainment">Top viewing sport</div>
            <div class="top-entertainment-text">
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/sport/sport4.webp">
                <div class="name-art-gallery">Snorkeling</div>
            </div>
        </section>

        <section class="invest-parent">
            <div class="invest-column"> 
                <div class="text-invest">Why you should invest in Sotogrande</div>


                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/people/peop-mob1.svg">
                        <div class="john-anderson-mob-info">
                            <div class="john-anderson-mob">John Anderson</div>
                            <div class="senior-real-mob">Senior Real Estate Broker</div>
                        </div>
                </div>

                <div class="autor-and-text">
                     <div class="autor-name-descr"> 
                        <div class="john-autor">John Anderson</div>
                        <div class="john-autor-descr">Senior Real Estate Broker</div> 
                    </div>
                     <div>
                         <div class="autor-full-text">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/sotograndepage/people/people3.png"> 
            </div>
        </section>

       
        <div class="top-projects">Top projects</div>
			<section class="projects-parent"> 

				<div class="top-project-name">Explore Top projects in Sotogrande
					<div class="area-inner__buttons">
						<button class="slidePrev-area" disabled>
							<img src="<?php echo get_template_directory_uri(); ?>/icons/arrow-left.svg" alt="Arrow Left" class="area__buttons--arrows" />
						</button>
						<button class="slideNext-area">
							<img src="<?php echo get_template_directory_uri(); ?>/icons/arrow-left.svg" alt="Arrow Left" class="area__buttons--arrows arrow-right" />
						</button>
					</div>
				</div>
			...
			<div class="projects-card-group-areas" id="projectsAreaSotogrande"></div>
			<span class="projects-card-group-text" id="projectsAreaTextSotogrande"></span>
		</section>
...
function renderAreaPage(container) {
  const showMoreBtn = container.querySelector("#show-more-btn");
  const prevButton = container.querySelector(".slidePrev-area");
  const nextButton = container.querySelector(".slideNext-area");
  const cardGroup = container.querySelector(".projects-card-group-areas");
  const cards = container.querySelectorAll(".card-area");

  let currentIndex = 0;
  const totalCards = cards.length;
  const cardsToShow = 2;

  // Функція для перемикання історії
  function toggleHistory() {
    const part2 = container.querySelector(".text-history-part2");
    const part3 = container.querySelector(".text-history-part3");

    const isHidden = part2.style.display === "none";

    part2.style.display = isHidden ? "block" : "none";
    part3.style.display = isHidden ? "block" : "none";
    showMoreBtn.textContent = isHidden ? "Hide all" : "Show more";
  }

  if (showMoreBtn) {
    showMoreBtn.addEventListener("click", toggleHistory);
  }

  function updateSlider() {
    const offset = currentIndex * (100 / cardsToShow);
    cardGroup.style.transform = `translateX(-${offset}%)`;

    prevButton.disabled = currentIndex === 0;
    nextButton.disabled = currentIndex >= totalCards - cardsToShow;
  }

  if (prevButton && nextButton && cardGroup) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  renderAreaPage(mainContent)
  headerContainer.appendChild(Header());
  feedbackFormContainer.appendChild(FeedbackForm());
  footerContainer.appendChild(Footer());
  
	  async function fetchSecondaryProjectsArea() {
    try {
            ...
            const projectsContainer = document.getElementById(
                "projectsAreaSotogrande"
            );
			const projectsAreaText = document.getElementById("projectsAreaTextSotogrande");

            projectsContainer.innerHTML = "";

			if (projectData.projects.length === 0) {
				projectsAreaText.textContent = "No projects found";
			} else {
    ...
    fetchSecondaryProjectsArea();
    window.addEventListener("popstate", fetchSecondaryProjectsArea);
...
function createProjectCard(project) {
    ...
    card.className = "card";
    card.href = `${language && "/" + language}/secondary?project=${project._id}`;
    ...
    const isFavorite = savedSecondaryProjects.some(p => p._id === project._id);

    // Card content, выводим только первые 3 изображения
    card.innerHTML = `
        <div>
              ...
              <div class="swiper-wrapper">
                ${images.slice(0, 3).map(image => `
                  <div class="swiper-slide">
                    <img class="frame-child" src="${image.original}" alt="${generalInfo.name}" />
                  </div>`).join('')}
              </div>
              <!-- Swiper Navigation -->
          ...
          <div class="frame-container">
            <div class="frame-div">
              <div class="marein-natura-parent">
                <div class="marein-natura">${generalInfo.name}</div>
                <div class="marbella-spain">${generalInfo.province}, Spain</div>
              </div>
              <div class="parent">
                <div class="marein-natura">€ ${project.generalInfo.price.toLocaleString()}</div>
                <div class="m21">€ ${Math.round(
                    project.generalInfo.price / project.generalInfo.size
                ).toLocaleString()} m<sup>2</sup></div>
              </div>
            </div>
            <div class="frame-item"></div>
            <div class="developer-name-parent">
              <div class="off-plan">${project.generalInfo.type}</div>
              <div class="off-plan">Size: ${project.generalInfo.size} sq.m</div>
            </div>
          </div>
        </div>
    `;

    // Обработчики событий для предотвращения прыжка страницы при нажатии на кнопки
    ...
    card.querySelector('.heart-wrapper').addEventListener('click', function (event) {
        ...
        if (projectIndex > -1) {
            ...
            this.querySelector('.heart-icon').setAttribute('fill', 'none'); // Reset color
        } else {
            // Add to favorites
            savedSecondaryProjects.push(project);
            this.querySelector('.heart-icon').setAttribute('fill', '#313131'); // Fill with color
        }

...
<main id="main-content"><div class="service"><div class="service-top">
    ...
    <div class="service-top-buttons"><a class="service-top-button">
      ...
      </a><a class="service-top-button" target="_blank" href="https://twitter.com/intent/tweet?text=https%3A%2F%2Fnew-site.pro-part.es%2F%23visa-service">
        <img src="<?php echo get_template_directory_uri(); ?>/icons/twitter.svg" alt="twitter">
      </a><a class="service-top-button" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnew-site.pro-part.es%2F%23visa-service">
      ...
      <h1 class="service-title">Visa Services</h1>
    <p class="service-grey-text">The Spanish Golden Visa is a special type of residence visa designed to attract foreign investors to Spain. Introduced in 2013, this visa allows investors and their families to reside in Spain for the entire year, providing a range of benefits that facilitate entry, stay, and investment activities. The Golden Visa program has become a popular option for those looking to reside in Europe, offering not only residency but also significant advantages in terms of mobility and quality of life.</p><ul class="service-competencies"><div class="service-list"></div><h2 class="service-competencies-title">Rights of a Spanish Golden Visa Holder</h2><p class="service-grey-text">Holders of a Spanish Golden Visa are entitled to several privileges, making it an attractive choice for investors.<br>      </p><li class="service-grey-text li-test"><span class="service-competencies-span">Residency: </span>
      Full-year residency in Spain without the obligation of permanent stay, providing the flexibility to live in Spain as desired.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Work Permit: </span>
        The right to work anywhere in Spanish territory, whether as an employee or a business owner.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Schengen Area Travel: </span>
       Visa-free travel within the Schengen Zone for up to 90 days within a 180-day period, offering freedom of movement across 26 European countries.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Family Reunification: </span>
        The Golden Visa extends to family members, allowing spouses, minor children, and adult children who are financially or physically dependent on the investor to obtain residence under the same conditions.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Requirements for Obtaining a Golden Visa and Investor Residence Permit</h2><p class="service-grey-text">To attract significant foreign investment, the Spanish government established legislation that simplifies the residency process for investors, offering two main instruments:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">1. </span><span class="service-text">Golden Visa: This is a residence visa granted to investors who make substantial investments in Spain.</span></li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">2. </span><span class="service-text">Residence Permit: After obtaining a Golden Visa, investors can apply for a residence permit for longer stays and more comprehensive residency rights.</span></li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Investment Options for Obtaining a Golden Visa</h2><p class="service-grey-text">To qualify for a Golden Visa, applicants must make a significant investment in the Spanish economy. The types of investments that qualify include:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">1. </span><span class="service-text">Real Estate Acquisition</span></li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">Investment </span>
         of at least €500,000 in immovable property, such as residential or commercial real estate. The investment must be free of any encumbrances or liens.
        </li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">2. </span><span class="service-text">Capital Contribution</span></li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">€1,000,000 </span>
         deposit in a Spanish bank or credit institution.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">€1,000,000 </span>
         in investment funds registered in Spain.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">€1,000,000 </span>
          in shares or equity of Spanish companies, contributing to the business growth and economic development of the country.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">€2,000,000 </span>
         in government bonds or other Spanish public debt instruments.
        </li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">3. </span><span class="service-text">Entrepreneurial Project</span></li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">An entrepreneurial </span>
         project that is implemented in Spain and deemed to be of significant public interest. The project must meet at least one of the following criteria:
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">Job Creation: </span>
          Contributing to the creation of new employment opportunities.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">Economic  </span>
       and Social Impact: Making a significant contribution to the economic and social development of the region where the project is being executed.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">Scientific </span>
          and Technological Innovation: Providing a notable contribution to scientific advancement or technological development.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Applying for the Investor Residence Permit</h2><p class="service-grey-text">Investors who hold a valid Golden Visa may apply for a residence permit, allowing them to reside in Spain for a longer period of time. Key points regarding the residence permit include:<br>      </p><li class="service-grey-text li-test"><span class="service-competencies-span">Eligibility: </span>
       Investors can apply for a residence permit if they hold a valid Golden Visa or a visa that expired no more than 90 days ago, provided that they have entered Spain at least once on the visa.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Tourist Visa Applicants: </span>
       Investors legally present in Spain on a tourist visa may also apply for a residence permit, enabling them to transition seamlessly from a temporary visitor to a resident.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Application Process: </span>
       Applications for the investor residence permit are submitted in person or through a legal representative to the Unidad de Grandes Empresas y Colectivos Estratégicos (UGE-CE) in Madrid, a special government institution responsible for handling high-value and strategic investments.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Key Facts About the Investor Residence Permit</h2><h2 class="service-competencies-title"></h2><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">1. </span><span class="service-text">Processing Time</span></li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">The application process </span>
          for the investor residence permit takes approximately 20 calendar days. If no official response is received within this period, the residence permit is automatically granted through administrative silence, meaning approval by default.
        </li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">2. </span><span class="service-text">Validity Period</span></li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">The initial  </span>
         investor residence permit is valid for two years, with the option to renew it for subsequent periods of five years, provided that the conditions of the initial investment are maintained.
        </li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">3. </span><span class="service-text">Rights of a Residence Permit Holder</span></li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">An investor   </span>
         residence permit grants virtually the same rights as a Golden Visa, including the right to reside and work in Spain. The main difference is the extended period of validity, providing a more permanent solution for investors wishing to establish a long-term presence in Spain.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Taxation Implications for Golden Visa and Residence Permit Holders</h2><p class="service-grey-text">A common question for investors considering the Golden Visa program is whether they are liable to pay taxes in Spain. The answer depends on whether they qualify as tax residents:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text-first li-test-first"><span class="service-competencies-span-first">Non-Tax Resident Status: </span>
         Simply holding a Golden Visa or a residence permit does not automatically make an investor a tax resident of Spain. The visa provides residency rights, but taxation depends on physical presence and financial ties.
        </li><h2 class="service-competencies-title"></h2><li class="service-grey-text-first li-test-first"><span class="service-competencies-span-first">Tax Residency Criteria: An individual is deemed a tax resident in Spain if: </span>
         
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">They reside  </span>
         in Spain for more than 183 days in a calendar year.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">They have  </span>
         the principal source of income or financial interests in Spain.
        </li><li class="service-grey-text-second li-test-second"><span class="service-competencies-span-second">Their spouse </span>
        and dependent minor children reside permanently in Spain.
        </li><h2 class="service-competencies-title"></h2><li class="service-grey-text-first li-test-first"><span class="service-competencies-span-first">Tax Benefits: </span>
          Investors who do not meet the tax residency criteria are not subject to Spanish income tax on their global income. They are only taxed on income generated within Spain.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Advantages of the Spanish Golden Visa Program</h2><p class="service-grey-text">The Spanish Golden Visa program offers numerous advantages to investors:<br>      </p><li class="service-grey-text li-test"><span class="service-competencies-span">Flexible Residency: </span>
       Investors are not required to live in Spain year-round, providing flexibility for those with business interests in multiple countries.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Ease of Family Reunification: </span>
       The process of bringing family members to Spain is straightforward, ensuring that the investor’s spouse, children, and dependent relatives can enjoy the same rights as the primary visa holder.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Access to the European Market: </span>
       Free movement within the Schengen Zone makes the Golden Visa an attractive option for those who need to travel frequently for business or leisure throughout Europe.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Permanent Residency Pathway: </span>
       After five years of continuous residence, Golden Visa holders can apply for permanent residency, and after ten years, they may be eligible for Spanish citizenship, provided that all conditions are met.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">How We Can Help</h2><p class="service-grey-text">Navigating the complexities of the Golden Visa and Investor Residence Permit process requires a clear understanding of Spanish immigration, real estate, and tax laws. Our firm offers:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Legal Guidance: </span>
      We provide expert advice on all aspects of the Golden Visa process, from choosing the right type of investment to completing all necessary paperwork.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Application Support: </span>
     We assist with the preparation and submission of applications, ensuring that all requirements are met for a successful outcome.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Family Member Inclusion: </span>
     Guidance on the family reunification process, helping investors bring their loved ones to Spain with minimal administrative burden.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Post-Investment Services: </span>
   Continued support after obtaining the Golden Visa, including real estate management, tax filings, and guidance on obtaining permanent residency or citizenship.
        </li><h2 class="service-competencies-title"></h2><p class="service-grey-text">Our firm is committed to providing end-to-end support for investors seeking to benefit from Spain's Golden Visa program. We understand the importance of a smooth process, whether for relocating your family, expanding your business into Europe, or securing a high-quality lifestyle in Spain. Contact us today to learn more about how we can assist you in obtaining a Spanish Golden Visa.<br>      </p><h2 class="service-competencies-title"></h2><div class="service-wrapper"></div></ul></div><div class="service-right"><div class="service-right-top">
    ...
    </div><div class="service-right-bottom slider-wrapper"><div class="cards-container" style="transform: translateX(0%);"><div class="card">
      <div class="card__top">
          <img class="card__image" src="<?php echo get_template_directory_uri(); ?>/images/card-2.webp" alt="card price">
        ...
        <div class="card__bottom">
          <div class="card__bottom--item">
            <h2 class="card__bottom--item-title">Marein Natura</h2>
            <p class="card__bottom--item-price">€ 2.790.000</p>
          </div>
          <div class="card__bottom--item">
            <p class="card__bottom--item-text">Marbella, Spain</p>
            <p class="card__bottom--item-text">€ 4.233 m2</p>
          </div>
          <hr class="card__bottom--line">
  
        </div>
         <div class="card__bottom--item">
            <p class="card__bottom--item-text">Developer name</p>
